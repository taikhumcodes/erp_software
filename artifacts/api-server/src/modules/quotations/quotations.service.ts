  ...
  async create(userId: string, body: Record<string, unknown>) {
    ...
    return prisma.$transaction(async (tx) => {
      ...
      const newQuotation = await QuotationsRepository.create(tx, {
        ...
        creditLimitDays: body['creditLimitDays'] !== undefined && body['creditLimitDays'] !== '' && body['creditLimitDays'] !== null ? parseInt(String(body['creditLimitDays']), 10) : null,
        paymentType: normalise(body['paymentType']),
  ...
  async update(id: string, userId: string, body: Record<string, unknown>) {
    ...
    return prisma.$transaction(async (tx) => {
      ...
      return QuotationsRepository.update(tx, id, {
        ...
        creditLimitDays: body['creditLimitDays'] !== undefined ? (body['creditLimitDays'] !== '' && body['creditLimitDays'] !== null ? parseInt(String(body['creditLimitDays']), 10) : null) : undefined,
        paymentType: body['paymentType'] !== undefined ? normalise(body['paymentType']) : undefined,
