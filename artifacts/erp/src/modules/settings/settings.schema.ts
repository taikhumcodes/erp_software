...
export const documentFooterSchema = z.object({
  ...
  termsEn: z.string().default('Goods sold can be exchanged or returned within 15 days from the date of purchase if the goods are in same condition as the time of purchase'),
  termsAr: z.string().default('يمكن استبدال أو إرجاع السلع المباعة خلال 15 يوما من تاريخ الشراء، شريطة أن تكون السلع بحالتها الأصلية وقت الشراء'),
});
