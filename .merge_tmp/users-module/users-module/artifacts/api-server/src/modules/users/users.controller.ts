...
export const UsersController = {
  ...
  async update(req: Request, res: Response, next: NextFunction) {
    try {
      const actor = getActor(req);
      const { id } = req.params;
      const user = await UsersService.update(actor, id!, req.body as Record<string, unknown>);
      res.json({ data: user });
    } catch (err) {
      next(err);
    }
  ...
  async updateStatus(req: Request, res: Response, next: NextFunction) {
    try {
      const actor = getActor(req);
      const { id } = req.params;
      const user = await UsersService.updateStatus(actor, id!, req.body as Record<string, unknown>);
      res.json({ data: user });
    } catch (err) {
      next(err);
    }
  ...
  async resetPassword(req: Request, res: Response, next: NextFunction) {
    try {
      const actor = getActor(req);
      const { id } = req.params;
      await UsersService.resetPassword(actor, id!, req.body as Record<string, unknown>);
  ...
  async delete(req: Request, res: Response, next: NextFunction) {
    try {
      const actor = getActor(req);
      const { id } = req.params;
      await UsersService.delete(actor, id!);
      res.status(204).send();
    } catch (err) {
      next(err);
    }
